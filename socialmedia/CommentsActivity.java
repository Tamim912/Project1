...
public class CommentsActivity extends AppCompatActivity {
    ...
    String url,name,post_key,userid;
    DatabaseReference Commentref,userCommentref,likesref,allpostref;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    String name_result,age_result,Url,uid,bio_result,web_result,email_result;
